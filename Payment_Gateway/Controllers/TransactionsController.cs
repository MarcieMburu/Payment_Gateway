...
namespace Payment_Gateway.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public TransactionsController(Payment_GatewayContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Transaction != null ? 
                          ...
                          Problem("Entity set 'Payment_GatewayContext.Transaction'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Payment_GatewayContext.Transaction'  is null.");
            }
            var transaction = await _context.Transaction.FindAsync(id);
            if (transaction != null)
            {
